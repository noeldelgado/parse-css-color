...
var hslRe = new RegExp(pattern$1);
...
var rgbaRe = new RegExp(pattern$3);
...
var rgbpRe = new RegExp(pattern$4);
...
var rgb4Re = new RegExp(pattern$5);
...
var rgb4pRe = new RegExp(pattern$6);
...
const parseCSSColor = (str) => {
  ...
  const hsl = hsl4Re.exec(str) || hslRe.exec(str);
  if (hsl) return getHSL(hsl);

  const rgb = rgb4Re.exec(str) || rgb4pRe.exec(str) || rgbpRe.exec(str) || rgbaRe.exec(str);
